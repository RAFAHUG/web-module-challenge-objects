...
function createMenuItem( item, bill, time /*Your code here*/){
const menu = {name: item, price: bill, category: time} ;
return menu; /*Your code here*/
}
...
*/
// function createMenuItem ( item, bill, time){
//   const pizza = {name: item, price: bill, category: time};
//   return pizza;
// }
...
function addReview(array,name,rating,feedback/*Your Code Here */){
...
return `${array[array.length - 1].name} gave the restaurant a ${array[array.length - 1].rating} star review, and their feedback was: ${array[array.length-1].feedback}` /*Your code here*/
} 
